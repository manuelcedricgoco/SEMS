        ...
        <div class="flex items-center gap-2 ml-auto">
            ...
            <div class="flex items-center gap-2.5 pl-2 sm:pl-3 border-l border-gray-200 dark:border-gray-700">
                <div class="hidden sm:block text-right leading-tight">
                    ...
                    <!-- ✅ FIX: show position (like attendance page) with dept_name as fallback -->
                    <p class="text-xs text-gray-400"><?=htmlspecialchars($userInfo['position'] ?? $userInfo['dept_name'] ?? 'Department')?></p>
                </div>
